...
public class GrpAutoClosestToHubPickupShoot extends SequentialCommandGroup {
    public GrpAutoClosestToHubPickupShoot(Drive driveSubsystem, BallPath ballPathSubsystem, Pickup pickupSubsystem, Shooter shooterSubsystem, Vision visionSubsystem, ShooterLookupTable lookupTable, double timer) {
        addCommands(
            ...
            new GrpShootWithVision(shooterSubsystem, visionSubsystem, ballPathSubsystem, lookupTable, timer),
